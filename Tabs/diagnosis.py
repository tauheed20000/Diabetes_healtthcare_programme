...
""", unsafe_allow_html=True)
    # Create two tabs
    tab1, tab2, tab3 = st.tabs(["Diagnosis 🩺", "Treatment 💊", "Dataset 📊"])
    ...
    with tab1:
        ...
        st.subheader("Input Your Health Parameters:")
        ...
        # Download section
        st.subheader("Download Your Personalized Report")
    ...
    with tab2:
            ...
            # Streamlit UI
            st.title("AI-Powered Treatment Recommendations")
            st.markdown(
                """
